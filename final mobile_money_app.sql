...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 23 avr. 2025 à 12:38
...
(10, 3, 'ehdhd', 'hdh', '0595187899', 'Active', '2025-04-23 10:19:59');
...
(7, 'merchant@gmail.com', '$2b$10$u9l.ZmgJMCfYs9t3/E8rBuePLnurWQSR2jdtC5Y5LK4wnePQHD2we', 'merchant', 'sales', 'ddh', '7777777777', 10302.00, 'Active', '2025-04-21 09:09:27'),
(10, 'pau@mail.com', '$2b$10$i5Cjb7WLrRpvhiA78CKNqujzZfPaXAwE2euWWkDwYI13CEowWz722', 'paul', 'fdf', 'dfd', '7777444444', 0.00, 'Active', '2025-04-23 10:20:39');
...
--
-- Déchargement des données de la table `merchant_transactions`
--

INSERT INTO `merchant_transactions` (`id`, `merchant_id`, `user_id`, `amount`, `fees`, `transaction_date`, `status`) VALUES
(4, 7, 9, 10.00, 0.00, '2025-04-22 19:32:48', 'completed'),
(5, 7, 2, 10.00, 0.00, '2025-04-22 20:26:53', 'completed'),
(6, 7, 2, 5.00, 0.00, '2025-04-22 20:31:14', 'completed'),
(7, 7, 2, 47.00, 0.00, '2025-04-22 20:38:41', 'completed'),
(8, 7, 2, 10.00, 0.00, '2025-04-22 20:41:52', 'completed'),
(9, 7, 2, 4.00, 0.00, '2025-04-22 21:46:37', 'completed'),
(10, 7, 2, 2.00, 0.00, '2025-04-23 09:18:17', 'completed'),
(11, 7, 2, 5.00, 0.00, '2025-04-23 09:53:26', 'completed'),
(12, 7, 10, 10000.00, 0.00, '2025-04-23 09:56:48', 'completed'),
(13, 7, 2, 17.00, 0.00, '2025-04-23 10:15:06', 'completed');
...
(49, 2, 9, 10.10, 0.10, 10.00, '2025-04-22 20:03:53', 0),
(50, 2, 6, 5.00, 0.05, 4.95, '2025-04-22 20:30:16', 0),
(51, 2, 6, 1.00, 0.00, 1.00, '2025-04-22 20:36:34', NULL),
(52, 2, 6, 5.00, 0.00, 5.00, '2025-04-22 21:45:34', NULL),
(53, 2, 3, 10.10, 0.10, 10.00, '2025-04-22 21:46:06', NULL),
(54, 2, 9, 5.05, 0.05, 5.00, '2025-04-23 09:17:24', NULL),
(55, 10, 7, 5000.00, 0.00, 5000.00, '2025-04-23 09:56:00', NULL),
(56, 2, 6, 10.00, 0.00, 10.00, '2025-04-23 10:14:13', NULL),
(57, 2, 3, 10.00, 0.10, 9.90, '2025-04-23 10:17:11', NULL);
...
INSERT INTO `user_account` (`user_id`, `user_email`, `user_password`, `fname`, `lname`, `phone_number`, `balance`, `status`) VALUES
(2, 'paul@gmail.com', '$2b$10$kPfF.Soyg4XWvHEdrpv54esvq79LRCnONw.VcTFGmFQ57ceSddlX6', 'paul', 'KOUAME', '0101905020', 792.02, 'active'),
(3, 'kpauleliel@gmail.com', '$2b$10$3ZRpGvxG8kT.C2qPyiidQ.BBY/w24QBXm.xnod/1e8PiP12hNXv/2', 'Paul ', 'Kouame', '0595187899', 23405.54, 'active'),
(6, 'mounir@mail.com', '$2b$10$GqpvvnNK5c7AOUbBmf.4vuUYp6WULPnIuGegnqHZBtT.PEtLB72AW', 'mounirrr', 'bamba', '1010101010', 74.65, 'active'),
(7, 'abc@mail.com', '$2b$10$eob9pfu6zxq5e0XU1rBcS.Tx8IgS.8QaoEWePaOE.jduCqYw48.9i', 'merchant', '', '5555555555', 5024.90, 'active'),
(8, '1@2.com', '$2b$10$hoK3wzoPBfD0DdSGQbwGget0X29JnSNcFZ8ZZMsg1EvhKGG5gOMhi', 'za', 'za', '4444444444', 100.00, 'active'),
(9, 'test1@gmail.com', '$2b$10$l8GhoeCNkNmf69lO9y6Ate.5Hx8GUxetyzViJNDm9uv63TJEk1ibW', 'test', 'test2', '1212121212', 2005.00, 'inactive'),
(10, 'kadertraore2002@gmail.com', '$2b$10$GXfCVR9LmTw2meMgPLI6L.o3fHLoBQa6jX4iLhNu3F59Kpj6CvG36', 'kader', 'traore', '0757628678', 985000.00, 'active'),
(11, 'kdtghaftyyfs@gmail.com', '$2b$10$x.IuucwD1i7FVOBGAlhZ9urvIpbs1dVN2FD3NbP88/gEinHfeAQTq', 'ali', 'abou', '075478956', 10000.00, 'active');
